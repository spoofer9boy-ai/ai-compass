...
- [Google Machine Learning Crash Course: Representation](https://developers.google.com/machine-learning/crash-course/representation) — High-level intuition on transforming raw data into features.
