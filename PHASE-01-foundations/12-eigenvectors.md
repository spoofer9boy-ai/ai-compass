...
- [PCA and Eigenvectors](https://apxml.com/courses/linear-algebra-essentials-ml/chapter-5-eigenvalues-eigenvectors/significance-pca) — Why eigenvectors of the covariance matrix are the principal components.
