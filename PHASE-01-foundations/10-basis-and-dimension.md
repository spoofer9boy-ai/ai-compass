...
- [Wikipedia: Basis (linear algebra)](https://en.wikipedia.org/wiki/Basis_%28linear_algebra%29) — Rigorous definition and key theorems, including the fact that all bases share the same cardinality.
